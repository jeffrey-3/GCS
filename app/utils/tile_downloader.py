...
class TileDownloader:
    ...
    def download_tiles_for_zoom(self, zoom_level, top_left, bottom_right):
        """Download tiles for a specific zoom level using top-left and bottom-right coordinates."""
    ...
    def download_all_tiles(self, top_left, bottom_right, min_zoom, max_zoom):
        """Download tiles for all specified zoom levels using top-left and bottom-right coordinates."""
        for zoom_level in range(min_zoom, max_zoom + 1):
            self.download_tiles_for_zoom(zoom_level, top_left, bottom_right)